...
INSERT INTO "new_TurnStatus" ("careCenterId", "createdAt", "final", "id", "initial", "ipsId", "isActive", "name", "updatedAt") SELECT "careCenterId", "createdAt", "final", "id", "initial", "ipsId", "isActive", "name", "updatedAt" FROM "TurnStatus";
