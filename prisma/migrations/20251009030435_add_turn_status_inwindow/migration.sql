...
CREATE TABLE "new_TurnStatus" (
    ...
    "inWindow" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_TurnStatus" ("careCenterId", "color", "createdAt", "final", "id", "initial", "ipsId", "isActive", "name", "order", "updatedAt") SELECT "careCenterId", "color", "createdAt", "final", "id", "initial", "ipsId", "isActive", "name", "order", "updatedAt" FROM "TurnStatus";
